    ...
    <div id="print-area">
        ...
        <section v-for="(d, di) in disciplinas" :key="di" class="disc">
            ...
            <table class="tbl">
                ...
                <tbody>
                    <tr v-if="!d.dias.length"><td :colspan="consolidado ? 5 : 4" class="vazio-disc">Nenhum dia registrado nesta disciplina.</td></tr>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y">
                                <tr v-if="!d.dias.length">
                                    <td :colspan="consolidado ? 5 : 4" class="px-3 py-3 text-center text-xs italic text-muted-foreground">Nenhum dia registrado nesta disciplina.</td>
                                </tr>
...
@media print {
    ...
    .tbl .vazio-disc { text-align: center; font-style: italic; }
