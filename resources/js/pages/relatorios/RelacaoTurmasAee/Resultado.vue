...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Relação de Turmas AEE', href: '/relatorios/relacao-turmas-aee' },
];
...
<template>
    <Head title="Relação de Turmas AEE" />
    ...
    <Teleport to="body">
        <div id="print-area">
            ...
            <h1 class="titulo">RELAÇÃO DE TURMAS AEE — {{ anoLetivo.anl_ano }}</h1>
            ...
            <table class="tab">
                ...
                <tfoot>
                    <tr>
                        <td colspan="5"><b>Total turmas: {{ total_turmas }}</b></td>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-[95%] py-6">
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-xl font-semibold">Relação de Turmas AEE — {{ anoLetivo.anl_ano }}</h1>
                <div class="flex gap-2">
                    <Link href="/relatorios/relacao-turmas-aee">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-fuchsia-600 text-white">
                        <tr>
                            ...
                            <th class="px-3 py-2.5 text-left font-semibold whitespace-nowrap">Dias de Atendimento</th>
...
@media print {
    ...
    .tab th, .tab td { border: 1px solid #444; padding: 4px 6px; font-size: 8.5pt; }
