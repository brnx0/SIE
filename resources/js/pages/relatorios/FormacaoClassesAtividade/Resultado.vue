...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Formação de Classes — Atividade', href: '/relatorios/formacao-classes-atividade' },
];
...
<template>
    <Head title="Formação de Classes — Atividade" />
    ...
    <div id="print-area">
        ...
        <div class="titulo-impressao">
            <h1>Formação de Classes — Atividade</h1>
        </div>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-[95%] py-6">
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-xl font-semibold">Resultado: Formação de Classes — Atividade</h1>
                <div class="flex gap-2">
                    <Link href="/relatorios/formacao-classes-atividade">
                ...
                <table class="w-full text-xs">
                    <thead class="bg-muted/40">
                        <tr>
                            ...
                            <th class="px-2 py-2 text-left">Atividade(s)</th>
                    ...
                    <tbody class="divide-y">
                        <tr v-for="l in linhas" :key="l.num">
                            ...
                            <td class="px-2 py-1.5">{{ l.atividades }}</td>
