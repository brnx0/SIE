...
function gerar() {
    ...
    router.get('/relatorios/relacao-turmas-atividade/gerar', payload, {
        preserveScroll: true,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-[95%] py-6">
            <h1 class="text-xl font-semibold mb-1 flex items-center gap-2">
                <Activity class="size-5 text-indigo-600" /> Relação de Turmas de Atividade
            </h1>
            <p class="text-sm text-muted-foreground mb-6">
                Lista turmas de atividade complementar com INEP, escola, turno, atividades, dias e qtd. de alunos.
            </p>
