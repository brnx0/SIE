...
import TurmaAeeForm from '@/components/turma-aee/TurmaAeeForm.vue';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: `Turma ${props.turma.tur_nome}`, href: `/turmas-aee/${props.turma.tur_id}/edit` },
];
</script>

<template>
    <Head :title="`Editar Turma AEE — ${turma.tur_nome}`" />
        ...
        <div class="mx-auto flex w-[95%] flex-col gap-6 p-4 md:p-6">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">
                    Editar Turma AEE — {{ turma.tur_nome }}
                </h1>
