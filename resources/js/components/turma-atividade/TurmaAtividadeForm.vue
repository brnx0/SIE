...
import TurmaAtividadeAlunosTab from '@/components/turma-atividade/tabs/TurmaAtividadeAlunosTab.vue';
import TurmaAtividadeProfessoresTab from '@/components/turma-atividade/tabs/TurmaAtividadeProfessoresTab.vue';
import TurmaAtividadeItensTab from '@/components/turma-atividade/tabs/TurmaAtividadeItensTab.vue';
...
const onEscolaChange = (v: number | null) => { form.tur_esc_id = v; };
...
const submit = () => {
    ...
    if (props.mode === 'create') {
        form.post('/turmas-atividade');
    } else {
        form.post(`/turmas-atividade/${props.initial?.tur_id}`);
    }
};

const submitLabel = props.mode === 'create' ? 'Cadastrar Turma Atividade' : 'Salvar Alterações';
...
<template>
    <div class="grid gap-6">
        <div class="flex items-center justify-between">
            <Link href="/turmas-atividade">
                <Button type="button" variant="outline">
                    <ChevronLeft class="mr-1 size-4" /> Voltar à lista
                </Button>
            </Link>
            <Button type="button" :disabled="form.processing" class="bg-teal-600 hover:bg-teal-700" @click="submit">
        ...
        <Tabs default-value="dados">
            <TabsList v-if="mode === 'edit'">
                ...
                <TabsTrigger value="itens">Atividades Oferecidas</TabsTrigger>
            </TabsList>
                    ...
                    <div class="grid gap-4 rounded-xl border bg-card p-6 shadow-sm">
                        ...
                        <div class="grid gap-4 sm:grid-cols-12">
                            ...
                            <div class="grid gap-1.5 sm:col-span-3">
                                ...
                                <Input v-model="form.tur_cd_inep" maxlength="20" placeholder="Opcional" />
                            ...
                            <div class="grid gap-1.5 sm:col-span-4">
                                ...
                                <Input v-model="form.tur_nome" maxlength="20" placeholder="ATV TURMA A" :class="{ 'border-red-500': form.errors.tur_nome }" />
                            ...
                            <div class="grid gap-1.5 sm:col-span-3">
                                ...
                                <Input v-model="form.tur_aee_sala" maxlength="100" placeholder="Opcional" />
                            </div>
                    ...
                    <div class="grid gap-4 rounded-xl border bg-card p-6 shadow-sm">
                        ...
                        <div class="grid gap-4 sm:grid-cols-12">
                            ...
                            <div class="grid gap-1.5 sm:col-span-6">
                                ...
                                <Input model-value="ATIVIDADE COMPLEMENTAR" disabled class="bg-muted cursor-not-allowed" />
                            </div>
            ...
            <TabsContent v-if="mode === 'edit'" value="alunos">
                <TurmaAtividadeAlunosTab :tur-id="initial!.tur_id" />
            </TabsContent>

            <TabsContent v-if="mode === 'edit'" value="professores">
                <TurmaAtividadeProfessoresTab
                    :turma="initial!"
            ...
            <TabsContent v-if="mode === 'edit'" value="itens">
                <TurmaAtividadeItensTab :tur-id="initial!.tur_id" />
            </TabsContent>
        </Tabs>
    </div>
</template>
