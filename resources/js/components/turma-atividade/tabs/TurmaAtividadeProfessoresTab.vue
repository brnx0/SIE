...
const submit = () => {
    ...
    router.post(`/turmas-atividade/${props.turma.tur_id}/professores`, form as Record<string, any>, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => resetForm(),
...
const remove = (tup: TurmaProfessor) => {
    ...
    router.delete(`/turmas-atividade/${props.turma.tur_id}/professores/${tup.tup_id}`, {
        preserveScroll: true,
        preserveState: true,
    });
};
    ...
    <div class="grid gap-6">
        ...
        <div v-if="showForm" class="rounded-xl border border-teal-200 bg-teal-50/50 p-5 shadow-sm dark:border-teal-800 dark:bg-teal-900/20">
            ...
            <div class="mt-4 flex justify-end gap-2">
                ...
                <Button type="button" size="sm" :disabled="processing" class="bg-teal-600 text-white hover:bg-teal-700" @click="submit">
