...
import type { AnoLetivo, ParametroEntidade, ParametroEntidadeFormData } from '@/types/parametro';
...
const TABS = ['entidade', 'ano_letivo', 'cadastros'] as const;
    ...
    <div class="grid gap-6">
        <Tabs v-model="activeTab">
            <TabsList>
                ...
                <TabsTrigger value="cadastros" :has-error="tabHasError('cadastros')">3. Cadastros</TabsTrigger>
            </TabsList>
