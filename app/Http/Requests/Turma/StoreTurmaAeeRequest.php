...
class StoreTurmaAeeRequest extends FormRequest
{
    ...
    /**
     * Força modalidade AEE e tipo de atendimento fixo, ignorando o que vier do cliente.
     */
    protected function prepareForValidation(): void
    {
        $this->merge([
            'tur_modalidade'       => Turma::MODALIDADE_AEE,
            'tur_tipo_atendimento' => 'ATENDIMENTO EDUCACIONAL ESPECIALIZADO - AEE',
            'tur_seg_id'           => null,
            'tur_ser_id'           => null,
        ]);
    }
    ...
    public function validated($key = null, $default = null): array
    {
        ...
        // Inclui os campos forçados em prepareForValidation (fora das rules).
        $data['tur_modalidade']       = Turma::MODALIDADE_AEE;
        $data['tur_tipo_atendimento'] = 'ATENDIMENTO EDUCACIONAL ESPECIALIZADO - AEE';
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            if ($exists) {
                $v->errors()->add('tur_nome', 'Já existe uma turma AEE com este nome para a escola, ano letivo e turno informados.');
            }
        });
    }
